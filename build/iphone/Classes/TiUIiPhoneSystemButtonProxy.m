...
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ACTIVITY,UIOMDbNativeItemSpinner,@"UI.iPhone.SystemButtonStyle.ACTIVITY",@"5.4.0",@"UI.iOS.SystemButtonStyle.ACTIVITY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(SPINNER,UIOMDbNativeItemSpinner,@"UI.iPhone.SystemButtonStyle.SPINNER",@"5.4.0",@"UI.iOS.SystemButtonStyle.SPINNER");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(INFO_LIGHT,UIOMDbNativeItemInfoLight,@"UI.iPhone.SystemButtonStyle.INFO_LIGHT",@"5.4.0",@"UI.iOS.SystemButtonStyle.INFO_LIGHT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(INFO_DARK,UIOMDbNativeItemInfoDark,@"UI.iPhone.SystemButtonStyle.INFO_DARK",@"5.4.0",@"UI.iOS.SystemButtonStyle.INFO_DARK");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(DISCLOSURE,UIOMDbNativeItemDisclosure,@"UI.iPhone.SystemButtonStyle.DISCLOSURE",@"5.4.0",@"UI.iOS.SystemButtonStyle.DISCLOSURE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(CONTACT_ADD,UIOMDbNativeItemContactAdd,@"UI.iPhone.SystemButtonStyle.CONTACT_ADD",@"5.4.0",@"UI.iOS.SystemButtonStyle.CONTACT_ADD");
