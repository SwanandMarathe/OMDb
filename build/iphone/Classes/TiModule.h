...
/**
 The base class for all OMDb modules
 */
...
/**
 OMDb Platform calls this method on startup.
 */
-(void)startup;

/**
 OMDb Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 OMDb Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 OMDb Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 OMDb Platform calls this method on resume.
 @param sender The sender of the event.
 */
