...
// in simulator we redefine to format for OMDb Developer console
...
{\
	NSString * exceptionName = [@"org.omdb." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.omdb";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIOMDbNativeItemNone = -1, 
	UIOMDbNativeItemSpinner = -2,
	UIOMDbNativeItemProgressBar = -3,
	
	UIOMDbNativeItemSlider = -4,
	UIOMDbNativeItemSwitch = -5,
	UIOMDbNativeItemMultiButton = -6,
	UIOMDbNativeItemSegmented = -7,
	
	UIOMDbNativeItemTextView = -8,
	UIOMDbNativeItemTextField = -9,
	UIOMDbNativeItemSearchBar = -10,
	
	UIOMDbNativeItemPicker = -11,
	UIOMDbNativeItemDatePicker = -12,
	
	UIOMDbNativeItemInfoLight = -13,
	UIOMDbNativeItemInfoDark = -14,
	
	UIOMDbNativeItemDisclosure = -15,
	
	UIOMDbNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all OMDb instances of
